...
public class Const {
    ...
    static final String SCREEN_RECORDING_START = "com.enchcorp.screenshare.services.action.startrecording";
    static final String SCREEN_RECORDING_PAUSE = "com.enchcorp.screenshare.services.action.pauserecording";
    static final String SCREEN_RECORDING_RESUME = "com.enchcorp.screenshare.services.action.resumerecording";
    static final String SCREEN_RECORDING_STOP = "com.enchcorp.screenshare.services.action.stoprecording";
